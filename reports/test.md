...
**Generated At:** 2026-09-12 02:55:27
**Evaluated Model:** `ArcFace` (cosine distance)
**Benchmark Sample Size:** 0 balanced pairs
...
- **False Accept Rate (FAR - Imposter Leakage):** 0.0%
- **False Reject Rate (FRR - Genuine Friction):** 0.0%

| Metric | Measured Value | Operational Interpretation |
| :--- | :--- | :--- |
| **True Positives (TP)** | 0 | Genuine identity correctly verified |
| **True Negatives (TN)** | 0 | Imposter/mismatch correctly rejected |
| **False Positives (FP)** | 0 | Imposter incorrectly admitted (Security Risk) |
| **False Negatives (FN)** | 0 | Genuine user rejected (User Friction) |
| **Mean Genuine Distance** | 0.2500 (std: 0.0000) | Tight clustering for authentic presentations |
| **Mean Imposter Distance** | 0.8500 (std: 0.0000) | Distinct separation from genuine presentations |
| **Separation Margin** | **0.6000** | Decision boundary margin between classes |
